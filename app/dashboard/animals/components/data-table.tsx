...
export function DataTable<TData, TValue>({
  ...
  const handleDeleteAnimalIntoCage = () => {
    // rowSelection
    ...
    if(selected.length == 0){
      ...
      unassignAnimalsIntoCage(selected)
      .then((res) => {
        toast({
          title: "Success",
          description: "Remove animals successfully",
        })
      })
      .finally(() => {
        setTimeout(() => {
  ...
  return (
    <div className="space-y-4">
      ...
      <Button type="button" variant="destructive" className="ml-auto" onClick={handleDeleteAnimalIntoCage}>Unassign Animals</Button>
    </div>
  )
}