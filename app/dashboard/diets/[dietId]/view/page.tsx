                            ...
                            <div className='flex'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <span className='text-base pl-2'>{diet?.totalEnergyValue} Kcal/
                                        {dateConverter(diet.scheduleAt, diet.endAt).toFixed(2)}day(s) (about {(diet?.totalEnergyValue / dateConverter(diet.scheduleAt, diet.endAt)).toFixed(2)} Kcal/day) <br /></span>
